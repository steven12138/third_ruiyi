...
ipcMain.on('ruiyi', (event, args) => {
    ...
    global.ruiyi.loadURL('https://bdfzres.lexuewang.cn:8008/analyse/web/index.html#/login');
    global.ruiyi.webContents.on("did-finish-load", function() {
        global.ruiyi.webContents.executeJavaScript('window.localStorage.setItem("obj",\'' + stringify_data + '\');');
        global.ruiyi.webContents.executeJavaScript('window.location.href="https://bdfzres.lexuewang.cn:8008/analyse/web/index.html#/examList";');
    })
